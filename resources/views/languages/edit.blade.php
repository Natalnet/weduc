                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="compile_code" id="compile_code" placeholder="Digite código de compilação" value="{{ old('compile_code') ?: $language->compile_code }}">
                        </div>
                        <div class="form-group">
                            <label for="extension">Extensão dos arquivos na linguagem</label>
                            <input type="text" class="form-control" name="extension" id="extension" placeholder="Digite código de compilação" value="{{ old('extension') ?: $language->extension }}">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea type="text" class="form-control" name="footnote" id="footnote" placeholder="Rodapé" rows="6">
                                    {{ old('footnote') ?: $language->footnote }}
                                </textarea>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea type="text" class="form-control" name="main_function" id="main_function" placeholder="Cabeçalho" rows="10">
                                    {{ old('main_function') ?: $language->main_function }}
                                </textarea>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea type="text" class="form-control" name="other_functions" id="other_functions" placeholder="Função na linguagem alvo" rows="6">
                                    {{ old('other_functions') ?: $language->other_functions }}
                                </textarea>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea type="text" class="form-control" name="declare_string" id="declare_string" placeholder="Declaração do Tipo Texto" rows="6">
                                    {{ old('declare_string') ?: $language->dataType()->get() }}
                                </textarea>
