        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" id="reduc-tab" class="nav-item">
                    <a href="#reduc" aria-controls="reduc" role="tab" data-toggle="tab" onclick="showReduc();" class="nav-link active">
                        <b>R-Educ</b>
                    </a>
                </li>
                <li role="presentation" id="custom-tab" class="nav-item">
                    <a href="#custom" aria-controls="custom" role="tab" data-toggle="tab" onclick="exportarPrograma();" class="nav-link">
                        <b>@{{ language.name }}</b>
                    </a>
                </li>
            </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <div class="card" :class="{ 'border-danger': errors }">
                                ...
                                <div id="editor-reduc" style="height: 400px; display: none;" class=" ace_editor ace-github"></div>
                                <div class="card-footer">
                                    <div id="comp-result">
                                        <span v-if="!errors" class="badge badge-success float-left">Success</span>
                                        <div class="text-info" v-if="errors">
                                            <b v-text="errors">Olá! Comece a programar aqui.</b>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <div class="card">
                                ...
                                <div id="editor-custom" style="height: 400px; display: none;" class=" ace_editor ace-github"></div>
                                <div class="card-footer">
                                    <div id="comp-result">
                                        <div class="text-info" v-if="errors">
                                            <b v-text="errors">Olá! Comece a programar aqui.</b>
